            ...
            <div className='border-2 rounded-md shadow mt-5'>
                <div className='border-b-2 border-gray-700 p-4'>
                    <input
                        ...
                        type="text" className='border-2 border-blue-500 rounded p-3 w-full'
                        onKeyDown={addTask}
                    />
                </div>
                            ...
                            return <div key={index} className='shadow-md border-2 rounded-lg p-4 mb-5'>
                                ...
                                <div className='mt-3 flex gap-3 justify-end'>
                                    <button onClick={() => { toggleComplete(index) }}
                                        className='bg-blue-500 text-white rounded-full px-3'>Edit</button>


                                    <button onClick={() => { deleteTask(index) }}
                                        className='bg-red-500 text-white rounded-full px-3'>Delete</button>
                                </div>
